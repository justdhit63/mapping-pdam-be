...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Okt 2025 pada 17.36
...
CREATE TABLE `pelanggan` (
  ...
  `jenis_meter` varchar(50) DEFAULT NULL,
  ...
  `distribusi` varchar(100) DEFAULT NULL,
  `sumber` varchar(100) DEFAULT NULL,
  `kondisi_meter` varchar(100) DEFAULT NULL,
  `kondisi_lingkungan` varchar(100) DEFAULT NULL,
  `kategori` varchar(50) DEFAULT NULL,
  `status_pelanggan` varchar(20) DEFAULT 'aktif',
  `no_registrasi` varchar(10) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  `foto_ktp_url` varchar(255) DEFAULT NULL,
  `foto_kk_url` varchar(255) DEFAULT NULL,
  `status_registrasi` enum('draft','pending','approved','rejected') DEFAULT 'draft',
  `tanggal_registrasi` datetime DEFAULT current_timestamp(),
  `catatan_registrasi` text DEFAULT NULL,
  `approved_by` int(11) DEFAULT NULL,
  `approved_at` datetime DEFAULT NULL,
  `rejected_reason` text DEFAULT NULL,
  `stand_meter` varchar(100) DEFAULT NULL,
  `nomer_water_meter` varchar(100) DEFAULT NULL,
  `merk_meter` varchar(50) DEFAULT NULL,
  `ukuran_water_meter` varchar(20) DEFAULT NULL,
  `kondisi_water_meter` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pelanggan` (`id`, `user_id`, `id_pelanggan`, `nama_pelanggan`, `no_telpon`, `alamat`, `jumlah_jiwa`, `jenis_meter`, `tanggal_pemasangan`, `longitude`, `latitude`, `foto_rumah_url`, `created_at`, `updated_at`, `cabang_id`, `desa_id`, `kecamatan_id`, `rayon_id`, `golongan_id`, `kelompok_id`, `distribusi`, `sumber`, `kondisi_meter`, `kondisi_lingkungan`, `kategori`, `status_pelanggan`, `no_registrasi`, `email`, `foto_ktp_url`, `foto_kk_url`, `status_registrasi`, `tanggal_registrasi`, `catatan_registrasi`, `approved_by`, `approved_at`, `rejected_reason`, `stand_meter`, `nomer_water_meter`, `merk_meter`, `ukuran_water_meter`, `kondisi_water_meter`) VALUES
(1, 1, 'PLG001', 'Budi Santoso', '081234567890', 'Jl. Merdeka No. 123, Jakarta', 4, 'Digital', '2024-01-15', 99.99999999, -6.20876300, NULL, '2025-09-05 10:27:06', '2025-09-05 15:49:23', 1, 2, 1, 5, 2, 3, NULL, NULL, NULL, NULL, NULL, 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 1, 'PLG002', 'Siti Rahayu', '081234567891', 'Jl. Sudirman No. 456, Jakarta', 3, 'Analog', '2024-02-20', 99.99999999, -6.22501400, NULL, '2025-09-05 10:27:06', '2025-09-05 15:49:23', 1, 8, 4, 7, 6, 1, NULL, NULL, NULL, NULL, NULL, 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 1, 'PLG003', 'Ahmad Rahman', '081234567892', 'Jl. Thamrin No. 789, Jakarta', 5, 'Digital', '2024-03-10', 99.99999999, -6.19571800, NULL, '2025-09-05 10:27:06', '2025-09-05 15:49:23', 1, 5, 3, 1, 11, 6, NULL, NULL, NULL, NULL, NULL, 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 2, 'PLG004', 'Andi Wijaya', '081234567893', 'Jl. Gatot Subroto No. 100, Jakarta', 2, 'Digital', '2024-04-05', 99.99999999, -6.20777700, NULL, '2025-09-05 10:27:23', '2025-09-05 15:49:23', 2, 2, 1, 1, 4, 1, NULL, NULL, NULL, NULL, NULL, 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 2, 'PLG005', 'Dewi Sartika', '081234567894', 'Jl. HR Rasuna Said No. 200, Jakarta', 3, 'Analog', '2024-05-12', 99.99999999, -6.21077700, NULL, '2025-09-05 10:27:23', '2025-09-05 15:49:23', 2, 9, 5, 1, 9, 1, NULL, NULL, NULL, NULL, NULL, 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 3, 'PLG006', 'Budi Hartono', '081234567895', 'Jl. Kuningan No. 300, Jakarta', 4, 'Digital', '2024-06-18', 99.99999999, -6.21577700, NULL, '2025-09-05 10:27:23', '2025-09-05 15:49:23', 3, 1, 1, 2, 1, 12, NULL, NULL, NULL, NULL, NULL, 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 2, '123123', 'PLG123', '123', 'Jalan Galumpit, Kota Kulon, Garut Kota, Garut, West Java, Java, 44115, Indonesia', 2, 'Digidaw', '2025-09-09', 99.99999999, -7.22554673, '/uploads/images/foto_rumah-1757074329133-88216392.jpg', '2025-09-05 12:12:09', '2025-09-05 15:49:23', 6, 7, 4, 7, 10, 9, NULL, NULL, NULL, NULL, NULL, 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 2, 'Test112', '112', '112', 'Jalan Ciledug, Kota Kulon, Garut Kota, Garut, West Java, Java, 44119, Indonesia', 2, 'Meteran', '2025-09-18', 99.99999999, -7.22778189, '/uploads/images/foto_rumah-1757088862315-875831793.jpg', '2025-09-05 16:14:22', '2025-09-05 16:14:22', 6, 8, 4, 4, 9, 9, '-', '-', '-', '-', 'jadwal harian', 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9, 2, 'test01', '01', '01', 'Kota Kulon, Garut Kota, Garut, West Java, Java, 44119, Indonesia', 2, 'metera', '2025-09-03', 99.99999999, -7.22773399, '/uploads/images/foto_rumah-1757089464121-327685925.jpg', '2025-09-05 16:24:24', '2025-09-05 16:24:24', 6, 8, 4, 5, 6, 13, 'a', 'b', 'c', 'd', 'jadwal harian', 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, 2, 'test02', '02', '02', 'Cintaasih, Cisurupan, Garut, West Java, Java, 44171, Indonesia', 2, 'meteran', '2025-09-19', 99.99999999, -7.33454563, '/uploads/images/foto_rumah-1757090077409-158145944.jpg', '2025-09-05 16:34:37', '2025-09-05 16:39:39', 2, 2, 1, 3, 7, 8, 'a', 'b', 'c', 'd', 'jadwal harian', 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(11, 2, 'test03', '03', '03', 'Kota Kulon, Garut Kota, Garut, West Java, Java, 44119, Indonesia', 2, 'Meteran', '2025-09-10', 99.99999999, -7.22784043, '/uploads/images/foto_rumah-1757090423352-31877651.jpg', '2025-09-05 16:40:23', '2025-09-06 02:18:12', 6, 12, 2, 4, 8, 8, 'a', 'b', 'c', 'd', 'jadwal harian', 'tidak aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12, 2, 'test04', '04', '04', 'Kota Kulon, Garut Kota, Garut, West Java, Java, 44119, Indonesia', 2, 'digidaw', '2025-09-09', 107.90802062, -7.22767545, '/uploads/images/foto_rumah-1757091093756-973644506.jpg', '2025-09-05 16:51:33', '2025-09-06 02:17:59', 6, 12, 2, 9, 8, 13, 'a', 'b', 'c', 'd', 'jadwal mingguan', 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(13, 5, 'SL001', 'SL001', '0011', 'Kota Kulon, Garut Kota, Garut, West Java, Java, 44119, Indonesia', 2, 'digital', '2025-09-25', 107.90811181, -7.22770738, '/uploads/images/foto_rumah-1757159992224-574382321.jpg', '2025-09-06 11:59:52', '2025-09-06 12:22:29', 6, 7, 4, 4, 8, 8, 'a', 'b', 'c', 'd', 'jadwal harian', 'aktif', NULL, NULL, NULL, NULL, 'draft', '2025-10-02 23:21:36', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, 2, 'asdsa123', 'asdasd', '123', 'asdaw', 1, NULL, NULL, 107.90846586, -7.22769674, '/uploads/images/foto_rumah-1759424289435-68955554.jpeg', '2025-10-02 16:58:09', '2025-10-03 15:11:49', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'baik', 'bersih', 'jadwal harian', 'aktif', '00001', 'testregist@example.com', '/uploads/images/foto_ktp-1759424289463-209607970.jpeg', '/uploads/images/foto_kk-1759424289468-849143265.jpeg', 'approved', '2025-10-02 23:58:09', NULL, 4, '2025-10-03 22:11:49', NULL, NULL, NULL, NULL, NULL, NULL),
(15, 2, 'asd123212123', 'Ilham Maulana Hasan', '08123123123', 'Godog', 100, 'Digidaw', '2025-10-07', 107.90818691, -7.22771803, '/uploads/images/foto_rumah-1759672058262-270975621.jpeg', '2025-10-05 13:47:39', '2025-10-05 13:49:57', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'baik', 'bersih', 'jadwal harian', 'aktif', '00002', 'ciom0410@gmail.com', '/uploads/images/foto_ktp-1759672058282-508188440.jpeg', '/uploads/images/foto_kk-1759672058283-640250610.jpeg', 'approved', '2025-10-05 20:47:39', 'Rumah ku dipuncak bang', 4, '2025-10-05 20:49:57', NULL, NULL, NULL, NULL, NULL, NULL),
(16, 2, NULL, 'test pel', '123', '-', 1, NULL, NULL, 107.90854365, -7.22770206, '/uploads/images/foto_rumah-1761663946370-983820275.png', '2025-10-28 15:05:46', '2025-10-28 15:05:46', NULL, 7, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'tidak aktif', '00003', 'testpel@pdam.com', '/uploads/images/foto_ktp-1761663946377-272724630.png', '/uploads/images/foto_kk-1761663946380-960372364.png', 'pending', '2025-10-28 22:05:46', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(2, 'user1@pdam.com', 'Sutedjo', 'user', 2, NULL, NULL, 1, '2025-10-28 16:33:58', '2025-10-28 16:33:58', '$2a$10$hEk5pAuZkRhKJKoIQCbEfe9utb6QA4.B5qIa5NgVl5y43IrDE0Ugy', '2025-09-05 10:27:23'),
...
(4, 'superadmin@pdam.com', 'Super Administrator', 'admin', 1, 'System Super Admin', '081234567891', 1, '2025-10-28 15:51:20', '2025-10-28 15:51:20', '$2a$10$hEk5pAuZkRhKJKoIQCbEfe9utb6QA4.B5qIa5NgVl5y43IrDE0Ugy', '2025-09-05 10:27:44'),
...
ALTER TABLE `pelanggan`
  ...
  ADD KEY `idx_no_registrasi` (`no_registrasi`),
  ADD KEY `idx_status_registrasi` (`status_registrasi`),
